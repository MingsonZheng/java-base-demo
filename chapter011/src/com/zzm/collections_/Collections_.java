...
public class Collections_ {
    public static void main(String[] args) {
        ...
        // 为了完成一个完整拷贝，我们需要先给dest 赋值，大小和List.size(0)一样
        ...
        // boolean replaceAll(List list， Object oldVal，bject newVal): 使用新值替换 List 对象的所有旧值
