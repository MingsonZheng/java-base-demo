...
public class Calendar_ {
    public static void main(String[] args) {
        ...
        // 3. 提供大量的方法和字段提供给程序员
        // 4. Calendar没有提供对应的格式化的类，因此需要程序员自已组合来输出(灵活)
        ...
        System.out.println(c.get(Calendar.YEAR) + "-" + (c.get(Calendar.MONDAY) + 1) + "-" + c.get(Calendar.DAY_OF_MONTH) +
