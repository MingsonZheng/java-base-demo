...
public class DiningTableService {// 业务层
    ...
    public boolean orderDiningTable(int id, String orderName, String orederTel) {
        int update = diningTableDAO.update("update diningTable set state='已经预定', orderName=?, orderTel=? where id=?", orderName, orederTel, id);
        return update > 0;
    }
