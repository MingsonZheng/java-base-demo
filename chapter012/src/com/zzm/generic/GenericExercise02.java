...
public class GenericExercise02 {
    public static void main(String[] args) {
        ...
        employees.add(new Employee("tom", 20000, new MyDate(1990, 11, 11)));
        employees.add(new Employee("tom", 20000, new MyDate(1990, 10, 11)));
        employees.add(new Employee("tom", 20000, new MyDate(1990, 10, 10)));
        employees.add(new Employee("jack", 12000, new MyDate(2001, 12, 12)));
        employees.add(new Employee("zzm", 50000, new MyDate(1980, 10, 10)));
...
5) 创建该类的 3个对象，并把这些对象放入 ArrayList 集合中(ArrayList 需使用泛型来定义)，
对集合中的元素进行排序，并遍历输出:

排序方式:调用ArrayList 的 sort 方法，传入 Comparator对象[使用泛型]，先按照name排序，
